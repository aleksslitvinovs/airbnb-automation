...
def test_search_destination(page, destination: str) -> None:
    ...
    home_page.search_for_booking(destination, checkin, checkout, number_of_guests)

    results_page = ResultsPage(page)
    results_page.validate_airbnb_url(destination, checkin, checkout)
...
# Retrieves page model based whether new or old page is displayed
